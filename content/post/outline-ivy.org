...
2. [[[https://github.com/ekaschalk/dotspacemacs/blob/master/elisp/outline-ivy.el][My package]] ~outline-ivy~ for jumping to outlines.
...
[[https://github.com/ekaschalk/dotspacemacs/blob/master/elisp/outline-ivy.el][Outline-ivy]] makes outlines a proper navigational, not just organizational, tool
with ~oi-jump~.
